            ...
            private List<List<String>> consultarDataCredito(String uid) {
                    ...
                    try {
                            ...
                            if (pExito.equals("TRUE")) {
                                    ...
                                    ResultSet rsInfDataFija = (ResultSet) cs.getObject(5);
                                    ...
                                    ResultSet rsInfTrUnMovil = (ResultSet) cs.getObject(6);
                                    ...
                                    ResultSet rsInfTrUnFija = (ResultSet) cs.getObject(7);
